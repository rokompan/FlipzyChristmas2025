...
- `pathTexture01-themeCastle.png` - `800x220` - Optional transparent PNG, seamless golden cobblestone road strip with darker outline and subtle highlights, no circles, no numbers.
...
- `pathTexture02-themePrincess.png` - `800x220` - Optional transparent PNG, seamless pink ribbon road with pearl dots and gold trim, no circles, no numbers.
...
- `pathTexture03-themeGarden.png` - `800x220` - Optional transparent PNG, seamless grassy trail with pale center stripe and tiny leaf marks, no circles, no numbers.
...
- `pathTexture04-themeSpace.png` - `800x220` - Optional transparent PNG, seamless blue galaxy road with dashed star lane marks, no circles, no numbers.
...
- `pathTexture05-themeOcean.png` - `800x220` - Optional transparent PNG, seamless aqua river road with foam highlights, no circles, no numbers.
...
- `pathTexture06-themeCandy.png` - `800x220` - Optional transparent PNG, seamless pink candy ribbon road with sprinkles, no circles, no numbers.
...
- `pathTexture07-themeDino.png` - `800x220` - Optional transparent PNG, seamless earthy trail with soft footprint marks, no circles, no numbers.
